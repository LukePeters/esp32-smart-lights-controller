from boot import KEY1, KEY2, KEY3
import tools
...
while station.isconnected():
    ...
    if (
        ...
        # Decide action based on how many presses
        if key3_press_count <= 7:
            tools.set_lifx_scene(key3_press_count - 1)
        else:
            print("KEY 3 PRESSED {} TIMES - NO MATCHING SCENE".format(key3_press_count))
        key3_press_count = 0  # Reset after handling
